import priorityImg from "../assets/icons/fi-rs-flag.svg"
...
export function taskRenderer(task) {
    ...
    priority.classList.add("project-view__task-priority", `task-priority__${task.getPriority()}`);
    priority.src = priorityImg;
